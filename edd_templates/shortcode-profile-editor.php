...
if (is_user_logged_in()):
	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo esc_url(edd_get_current_page_url()); ?>" method="post">
		...
		<fieldset id="edd_profile_personal_fieldset" class="border border-border-color p-8 pb-10 pt-6 rounded mb-10">
		...
		<fieldset id="edd_profile_address_fieldset" class="border border-border-color p-8 pb-10 pt-6 rounded mb-10">
