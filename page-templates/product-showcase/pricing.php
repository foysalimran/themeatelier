            ...
            <div class="tab-pane tab-pane-active">
                <div class="grid grid-cols-1 lg:grid-cols-3 lg:border-[1.5px] lg:border-solid lg:border-[#b0b3bc] rounded-lg">
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0">
                        ...
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=1" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                    ...
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0 popular">
                        ...
                        <div class="flex items-end justify-center">
                            <p class="mb-0 text-lg font-bold">$</p>
                            <h4 class="text-4xl font-bold">99</h4>
                            <p class="mb-0">/ Yearly</p>
                        </div>
                        <hr class="mt-10 mb-10 bg-secondary text-secondary">
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=2" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                        <ul class="features-list">
                        <li>
                    ...
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0">
                        ...
                        <div class="flex items-end justify-center">
                            <p class="mb-0 text-lg font-bold">$</p>
                            <h4 class="text-4xl font-bold">199</h4>
                            <p class="mb-0">/ Yearly</p>
                        </div>
                        <hr class="mt-10 mb-10 bg-secondary text-secondary">
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=3" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                        <ul class="features-list">
                        <li>
            ...
            <div class="tab-pane">
                <div class="grid grid-cols-1 lg:grid-cols-3 lg:border-[1.5px] lg:border-solid lg:border-[#b0b3bc] rounded-lg">
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0">
                        ...
                        <div class="flex items-end justify-center">
                            <p class="mb-0 text-lg font-bold">$</p>
                            <h4 class="text-4xl font-bold">129</h4>
                            <p class="mb-0">/ Yearly</p>
                        </div>
                        <hr class="mt-10 mb-10 bg-secondary text-secondary">
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=4" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                        <ul class="features-list">
                        <li>
                            <strong>Activation on 1 Website</strong>
                    ...
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0 popular">
                        ...
                        <div class="flex items-end justify-center">
                            <p class="mb-0 text-lg font-bold">$</p>
                            <h4 class="text-4xl font-bold">229</h4>
                            <p class="mb-0">/ Yearly</p>
                        </div>
                        <hr class="mt-10 mb-10 bg-secondary text-secondary">
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=5" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                        <ul class="features-list">
                        <li>
                            <strong>Activation on 5 Websites</strong>
                    ...
                    <div class="p-6 lg:p-10 pricing_item border-[1.5px] border-solid border-[#b0b3bc] lg:border-0 lg:border-none rounded-md mb-4 lg:rounded-none lg:mb-0">
                        ...
                        <div class="flex items-end justify-center">
                            <p class="mb-0 text-lg font-bold">$</p>
                            <h4 class="text-4xl font-bold">399</h4>
                            <p class="mb-0">/ Yearly</p>
                        </div>
                        <hr class="mt-10 mb-10 bg-secondary text-secondary">
                        <a target="_blank" href="https://themeatelier.net/checkout?edd_action=add_to_cart&download_id=534&edd_options[price_id]=6" class="w-full text-center ta-btn-secondary group">Buy Now</a>
                        <div class="h-8"></div>
                        <ul class="features-list">
                        <li>
                ...
                <p class="mt-10 mb-0 text-center">A lifetime license entitles you to updates and support forever. It is a <strong>One-time Payment</strong>, not a subscription.</p>
            </div>
        </div>
    </div>
</section>