<section class="max-w-5xl px-10 py-8 mx-auto -mt-16 bg-white shadow-md statistics rounded-xl">
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="flex gap-3 statistic_item">
            ...
            <div class="content">
                <p class="text-2xl text-[#333] pb-0 mb-0 font-bold">5.00</p>
                <p>Based on 3 Reviews</p>
            </div>
        </div>
        <div class="flex gap-3 statistic_item">
            <div class="w-16 h-16 flex items-center justify-center rounded-md bg-[#DCF5F0]">
                <svg class="w-8 fill-[#00A98D]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
