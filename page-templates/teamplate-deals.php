...
<section class="pt-[180px] pb-[180px] bg-[#111] text-white blackfriday-hero">
    <div class="container text-center">
        ...
        <div class="countdown" data-Date='2024/12/03 23:59:00'>
            <div class="uppercase text-xl tracking-wider  font-medium"><p>Deals are Expiring in:</p></div>
            <div class="justify-center font-mono text-2xl running">
                <timer class="flex gap-5">
                    <div class="shadow-lg bg-[#ffffff14] single_timer_container w-[100px] h-[100px] flex items-center justify-center rounded gap-0 p-2  border border-solid border-slate-400">
                        <div>
                        <span class="days block aclonica-regular text-4xl"></span>
                        <span class="timer-title block text-lg uppercase text-slate-400">Days</span>
                        </div>
                    </div>

                    <div class="shadow-lg bg-[#ffffff14] single_timer_container w-[100px] h-[100px] flex items-center justify-center rounded gap-0 p-2  border border-solid border-slate-400">
                        <div>
                        <span class="hours block aclonica-regular text-4xl"></span>
                        <span class="timer-title block text-lg uppercase text-slate-400">Hours</span>
                        </div>
                    </div>

                    <div class="shadow-lg bg-[#ffffff14] single_timer_container w-[100px] h-[100px] flex items-center justify-center rounded gap-0 p-2  border border-solid border-slate-400">
                        <div>
                        <span class="minutes block aclonica-regular text-4xl"></span>
                        <span class="timer-title block text-lg uppercase text-slate-400">Minutes</span>
                        </div>
                    </div>

                    <div class="shadow-lg bg-[#ffffff14] single_timer_container w-[100px] h-[100px] flex items-center justify-center rounded gap-0 p-2  border border-solid border-slate-400">
                        <div>
                        <span class="seconds block aclonica-regular text-4xl"></span>
                        <span class="timer-title block text-lg uppercase text-slate-400">Seconds</span>
                        </div>
                    </div>
...
<section class="pb-20">
    <div class="container">
        <div class="grid gap-8 -mt-[100px] md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="overflow-hidden border rounded bg-secondary shadow-xl hover:shadow-none transition-all duration-300">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 border border-slate-200 bg-white rounded">
                    ...
                    <div class="mb-5 pricing font-bold">
