        ...
        <div class="grid gap-8 -mt-[100px] md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/LPeXVY" target="_blank">
                                <img src="https://s3.envato.com/files/435013314/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 30% Off
                    ...
                    <div class="flex gap-2">
                        ...
                        <a target="_blank" href="https://1.envato.market/LPeXVY" class="ta-btn-primary !bg-[#19BC9E] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/x9Ba1y" target="_blank">
                                <img src="https://s3.envato.com/files/429845254/Thumbnail.jpg" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 10% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#0F8C7F] transition-all duration-300" href="https://1.envato.market/x9Ba1y">Better WhatsApp Chat Support WordPress Plugin</a>
                    </h3>
                    <p class="text-lg ">
                        Better WhatsApp Chat Support allows you to easily add a WhatsApp chat bubble, button and WooComemrce quote button to your website.
                    </p>
                    <div class="mb-5 font-bold pricing">
                        <sup class="font-bold text-[#0F8C7F] text-lg">$</sup> <span class="font-bold text-[#0F8C7F] text-4xl">21</span> <sub>/Lifetime</sub>
                    </div>
                    <div class="flex gap-2">
                        <a target="_blank" href="https://wpchatplugins.com/whatsapp-chat-support/" class="ta-btn-secondary !border-[#0F8C7F] hover:bg-[#0F8C7F] !text-[#0F8C7F]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/x9Ba1y" class="ta-btn-primary !bg-[#0F8C7F] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
             -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/idonate" target="_blank">
                                <img src="https://s3.envato.com/files/242484339/thumb.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 10% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#BA0015] transition-all duration-300" href="https://1.envato.market/idonate">Idonate - Blood Donation, Request And Donor Management System</a>
                    </h3>
                    <p class="text-lg ">
                        iDonate is a lightweight, powerful WordPress plugin designed to streamline the process of managing blood donations and requests.
                    </p>
                    <div class="mb-5 font-bold pricing">
                        <sup class="font-bold text-[#BA0015] text-lg">$</sup> <span class="font-bold text-[#BA0015] text-4xl">21</span> <sub>/Lifetime</sub>
                    </div>
                    <div class="flex gap-2">
                        <a target="_blank" href="https://bloodwp.com/" class="ta-btn-secondary !border-[#BA0015] hover:bg-[#BA0015] !text-[#BA0015]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/idonate" class="ta-btn-primary !bg-[#BA0015] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/eventful" target="_blank">
                                <img src="https://s3.envato.com/files/483743042/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 35% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#263AD0] transition-all duration-300" href="https://1.envato.market/eventful">Events Showcase For The Events Calendar</a>
                    </h3>
                    <p class="text-lg ">
                        Display your upcoming events from the Events Calendar plugin in beautiful, customizable layouts. Packed with powerful tools, this plugin takes your event showcasing to the next level.
                    </p>
                    <div class="mb-5 font-bold pricing">
                        <sup class="font-bold text-[#263AD0] text-lg">$</sup> <span class="font-bold text-[#263AD0] text-4xl">29</span> <sub>/Lifetime</sub>
                    </div>
                    <div class="flex gap-2">
                        <a target="_blank" href="https://wp-plugins.themeatelier.net/eventful/eventful-el-carousel/" class="ta-btn-secondary !border-[#263AD0] hover:bg-[#263AD0] !text-[#263AD0]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/eventful" class="ta-btn-primary !bg-[#263AD0] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#03B677] transition-all duration-300" href="http://1.envato.market/942x4">Bizreview - Business Review WordPress Plugin</a>
                    </h3>
                    <p class="text-lg ">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a target="_blank" href="http://1.envato.market/942x4" class="ta-btn-primary !bg-[#03B677] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
        ...
        <div class="grid gap-8 md:grid-cols-2">
            ...
            <div class="overflow-hidden transition-all duration-300 bg-white border rounded shadow-xl hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start gap-5 mb-3">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://ta-demo-nu.vercel.app/wonted" target="_blank">
                                <img src="https://previews.customer.envatousercontent.com/files/397760666/Thumbnail.jpg" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div>
                            <div class="flex gap-2">
            ...
            <div class="overflow-hidden transition-all duration-300 bg-white border rounded shadow-xl hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start gap-5 mb-3">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://ta-demo-nu.vercel.app/wonted-react" target="_blank">
                                <img src="https://previews.customer.envatousercontent.com/files/402195830/Thumbnail.jpg" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div>
                            <div class="flex gap-2">
                            ...
                            <h3 class="m-0 text-2xl leading-6 leading-8">
                                <a target="_blank" class="text-font-color hover:text-[#c27b7f] transition-all duration-300" href="https://ta-demo-nu.vercel.app/wonted-react">Wonted - Book & Author React Template</a>
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-2">
                        <a target="_blank" href="https://ta-demo-nu.vercel.app/wonted-react" class="ta-btn-secondary !border-[#c27b7f] hover:bg-[#c27b7f] !text-[#c27b7f]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/wonted-react" class="ta-btn-primary !bg-[#c27b7f] hover:!bg-[#000000]">Buy Now For $29</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/essential-elementor" target="_blank">
                                <img src="https://previews.customer.envatousercontent.com/files/500778298/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 30% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#92003A] transition-all duration-300" href="https://1.envato.market/essential-elementor">Essential Addons Bundle for Elementor Page Builder</a>
                    </h3>
                    <p class="text-lg ">
                        Greet is a powerful, user-friendly video bubble plugin for WordPress, designed to create dynamic and engaging welcome experiences for your website visitors.
                    </p>
                    <div class="mb-5 font-bold pricing">
                        <sup class="font-bold text-[#92003A] text-lg">$</sup> <span class="font-bold text-[#92003A] text-4xl">39</span> <sub>/Lifetime</sub>
                    </div>
                    <div class="flex gap-2">
                        <a target="_blank" href="https://1.envato.market/essential-elementor" class="ta-btn-secondary !border-[#92003A] hover:bg-[#92003A] !text-[#92003A]">Check Detail</a>
                        <a target="_blank" href="https://1.envato.market/essential-elementor" class="ta-btn-primary !bg-[#92003A] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/essential-plugin" target="_blank">
                                <img src="https://previews.customer.envatousercontent.com/files/482690541/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 60% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#21759A] transition-all duration-300" href="https://1.envato.market/essential-plugin">Essential Plugin Bundle for WordPress</a>
                    </h3>
                    <p class="text-lg ">
                        Turn your domains into cash with the Domain For Sale WordPress Plugin—the perfect tool for transforming your unused domain names into profitable opportunities.
                    </p>
                    <div class="mb-5 font-bold pricing">
                        <sup class="font-bold text-[#21759A] text-lg">$</sup> <span class="font-bold text-[#21759A] text-4xl">59</span> <sub>/Lifetime</sub>
                    </div>
                    <div class="flex gap-2">
                        <a target="_blank" href="https://1.envato.market/essential-plugin" class="ta-btn-secondary !border-[#21759A] hover:bg-[#21759A] !text-[#21759A]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/essential-plugin" class="ta-btn-primary !bg-[#21759A] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="overflow-hidden transition-all duration-300 border rounded shadow-xl bg-secondary hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/LXBYPY" target="_blank">
                                <img src="https://previews.customer.envatousercontent.com/files/490407469/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                        <div class="inline-block bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                            Flat 40% Off
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#263AD0] transition-all duration-300" href="https://1.envato.market/LXBYPY">Events Showcase For Elementor And The Events Calendar</a>
                    </h3>
                    <p class="text-lg ">
                        Turn your domains into cash with the Domain For Sale WordPress Plugin—the perfect tool for transforming your unused domain names into profitable opportunities.
                    </p>
                    ...
                    <div class="flex gap-2">
                        <a target="_blank" href="https://1.envato.market/LXBYPY" class="ta-btn-secondary !border-[#263AD0] hover:bg-[#263AD0] !text-[#263AD0]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/LXBYPY" class="ta-btn-primary !bg-[#263AD0] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
            ...
            <div class="col-span-12 lg:col-span-5">
                <svg id="Layer_3" data-name="Layer 3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 572.826 512.288">
                    <g>
                        ...
                        <path d="M560.939,344.8a271.423,271.423,0,0,1-56.823,166.609H72.494A271.423,271.423,0,0,1,15.671,344.8c0-150.573,122.067-272.628,272.64-272.628S560.939,194.231,560.939,344.8Z" fill="#3464E0" opacity="0.1"></path>
                        <g>
                            <g>
                            ...
                            <g>
                                ...
                                <path d="M117.118,191.726,159.4,289.371l58.34-79.847L268.3,255.1,181.962,366.916l-.566.8a34.519,34.519,0,0,1-58.424-4.276l-60.8-141.151Z" fill="#3464E0"></path>
                                ...
                                <path d="M508.127,207.589l-32.144,82.433-46.933-65.9L378.5,269.7l72.393,110.546.566.8a34.52,34.52,0,0,0,58.425-4.276l51.93-139.883Z" fill="#3464E0"></path>
                        ...
                        <g>
                            <path d="M162.841,131.272V10.245A10.245,10.245,0,0,0,152.6,0H10.245A10.245,10.245,0,0,0,0,10.245v90.242a10.245,10.245,0,0,0,10.245,10.245H125.917l32.262,22.945A2.951,2.951,0,0,0,162.841,131.272Z" fill="#3464E0"></path>
                            <g>
