            ...
            <div class="overflow-hidden transition-all duration-300 bg-white border rounded shadow-xl hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    <div class="flex items-start justify-between gap-3 mb-5">
                        <div class="inline-block p-1 bg-white border rounded border-slate-200">
                            <a href="https://1.envato.market/LXBYPY" target="_blank">
                                <img src="https://s3.envato.com/files/490407469/Thumbnail.png" class="max-w-[100px] rounded-sm" />
                            </a>
                        </div>
                    ...
                    <h3 class="mt-3 mb-2 text-2xl leading-6 leading-8">
                        <a target="_blank" class="text-font-color hover:text-[#0015B5] transition-all duration-300" href="https://1.envato.market/LXBYPY">Events Showcase For Elementor & Events Calendar</a>
                    </h3>
                    <p class="text-lg ">
                    ...
                    <div class="flex gap-2">
                        <a target="_blank" href="https://wp-plugins.themeatelier.net/eventful/eventful-el-carousel/" class="ta-btn-secondary !border-[#0015B5] hover:bg-[#0015B5] !text-[#0015B5]">Live Demo</a>
                        <a target="_blank" href="https://1.envato.market/LXBYPY" class="ta-btn-primary !bg-[#0015B5] hover:!bg-[#000000]">Purchase Now</a>
                    </div>
                </div>
            </div>
            <!-- Single product end -->
             ...
             <div class="overflow-hidden transition-all duration-300 bg-white border rounded shadow-xl hover:shadow-none">
                <div class="p-5 px-[30px] pb-[26px]">
                    ...
                    <div class="flex gap-2">
                        <a target="_blank" href="https://ta-demo-nu.vercel.app/essential-elementor" class="ta-btn-secondary !border-[#93003A] hover:bg-[#93003A] !text-[#93003A]">Live Demo</a>
