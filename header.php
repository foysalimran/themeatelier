        ...
        <ul>
          <li class="pb-2 md:pb-0">
            <a class="relative header-cart" href="/checkout"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              ...
              <div class="absolute inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-500 rounded-full top-0 -end-2"><?php echo edd_get_cart_quantity(); ?></div>
            </a>
          </li>
