...
<body <?php body_class(); ?>>
  <header class="cwp-header bg-white" id="menu">
        ...
        <ul>
          ...
          <li class="group relative ml-0 lg:!ml-4 my-1 lg:my-0 sm:flex-col">
            ...
            <div class="top-12 lg:pt-6 lg:group-hover:pt-3 -left-8 lg:absolute hidden group-hover:block lg:block lg:invisible group-hover:visible">
              <ul class="dropdown_menu !block bg-white lg:after:border-b-secondary after:z-50 min-w-[150px] rounded-md lg:opacity-0 group-hover:opacity-100 ease-linear duration-100 after:invisible after:opacity-0 group-hover:after:opacity-100 lg:after:visible after:absolute after:left-16 lg:after:border-[10px] after:-top-2 after:border-transparent lg:shadow-md lg:border border-solid border-secondary">
